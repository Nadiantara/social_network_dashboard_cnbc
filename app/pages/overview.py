...
start_date = st.sidebar.date_input("Start date", value=date(2023, 2, 8))
end_date = st.sidebar.date_input("End date", value=date(2023, 3, 14))
...
col5.metric("Link Clicked", f"{(number_start_link_clicked)}", '{:.1%}'.format(link_clicked_diff))
